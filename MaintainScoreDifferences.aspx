<%@ Page Title="" Language="C#" MasterPageFile="~/CrossFileMaster.master" AutoEventWireup="true" CodeFile="MaintainScoreDifferences.aspx.cs" Inherits="MaintainScoreDifferences" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPage" Runat="Server">
    <div class="PageWrapForAdmin">
        ...
        <div style="float:left; margin-top:10px;">
            <asp:Label ID="Label1" runat="server" Text="Score Differences" font-name="Franklin Gothic Medium Cond" Font-Size="24pt" ForeColor="Red"></asp:Label>
        </div>
        ...
        <div style="margin-top:60px">
            ...
            <br />
        <telerik:RadGrid ID="ScoreDifferencesRG" runat="server" CellSpacing="0"  GridLines="Both" AutoGenerateHierarchy="True" AllowAutomaticDeletes="True"
                         AllowAutomaticInserts="True" AllowAutomaticUpdates="True" AutoGenerateColumns="False" width="300" OnItemCommand="ScoreDifferencesRG_ItemCommand">
        <MasterTableView >
            <HeaderStyle/>
